...
public class RsiScanResult
{
    ...
    public string AnalysisTicker { get; set; } = string.Empty;
    public string AnalysisMarket { get; set; } = string.Empty;
    public string AnalysisCurrency { get; set; } = string.Empty;
    public bool UsesUnderlyingSecurity { get; set; }
    ...
    /// <summary>Date of the completed daily OHLCV bar used for this scan.</summary>
    ...
    public RsiScanResult Copy() => (RsiScanResult)MemberwiseClone();
}
...
public class EodSignalRecord
{
    ...
    public string TriggerDetails { get; set; } = string.Empty;
    /// <summary>Date of the completed market bar that produced this EOD signal.</summary>
...
public class DailySignal
{
    ...
    /// <summary>Date of the completed market bar that produced this lifecycle record.</summary>
    public string? TradingDate { get; set; }
    /// <summary>UTC timestamp when the scanner evaluated the completed market bar.</summary>
    public DateTime? ScannedAt { get; set; }
    /// <summary>Completed OHLCV sessions since TradingDate, calculated when queried.</summary>
    [System.ComponentModel.DataAnnotations.Schema.NotMapped]
    public int? TradingSessionsPassed { get; set; }
